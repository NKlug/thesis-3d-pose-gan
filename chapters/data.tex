...
Protocol 2 offers several advantages over Protocol 1.
...
\Todo[inline]{Also compare Protocol 1 and 2: "Rotation is the key difference while rotation and translation of the Procrustes transformation might also be better" Protocol 1 undurchsichtiges alignment und scaling for imperfect estimated poses especially with all the authors not explicitly mentioning which rigid alignment they use }