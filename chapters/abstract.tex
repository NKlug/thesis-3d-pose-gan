\begin{abstract}
	...
	The goal of this thesis is to analyze the effects of this normalization on the quantitative performance of the 3D pose estimation in that system.
	...
	With this new loss, the error can be reduced by more than $7\%$. 
