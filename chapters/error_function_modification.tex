\section{Exploiting bilateral symmetry for improved results}
...
The generator trained with the modified loss is able to outperform the generator with standard loss in all but one category.
The average MPJPE is reduced by 3.4mm to 51.4mm, which equals a improvement of 6\%.
For the individual activities the error is reduced by up to 5mm.
