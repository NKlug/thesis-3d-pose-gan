...
Architecture-wise, the generator takes the $n$ 2D joints of the pose $p$ (i.e. $2n$ scalar inputs) as input and feeds them to a fully connected layer of size 1024.
