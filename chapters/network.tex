...
Both generator and discriminator consist of several consecutive residual blocks.
...
\citet{drover18} suggest two additional Batch Normalization layers \cite{ioffe15} immediately after each fully connected layer.
...
The output is then reduced by by another fully connected layer to a vector of size 2.
