...
The smaller the camera distance, the more extreme the change in relative projection ray angles. 

It is remarkable that for $dz = 0$, the scaled theoretical MPJPE is already at 5mm.
...
Especially in production this issue could have been more severe, as the absolute depth of the 3D poses changes.
