...
\begin{document}
	...
	\Todo[inline]{Note to myself: Beim Korrekturlesen darauf achten ob Sachen benutzt werden, die vorher nicht erläutert wurden. Außerdem:
		Werden die Zusammenhänge überall klar?
		Wird die Motivation, bestimmte Dinge zu tun/ zu analysieren klar?
		Check for abbreviations like "don't".
		Check for spaces before points and commas.
	}
